...
go install github.com/LdDl/horizon/cmd/horizon@v0.8.0
```

Via downloading prebuilt binary and making updates in yours PATH environment varibale (both Linux and Windows):
* Windows - https://github.com/LdDl/horizon/releases/download/v0.8.0/windows-horizon.zip
* Linux - https://github.com/LdDl/horizon/releases/download/v0.8.0/linux-amd64-horizon.tar.gz
