...
* Windows - https://github.com/LdDl/horizon/releases/download/v0.4.0/windows-horizon.zip
* Linux - https://github.com/LdDl/horizon/releases/download/v0.4.0/linux-horizon.tar.gz
